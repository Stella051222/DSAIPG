 ...
 * time of algorithms.
 * It is part of the repository for the INFO6205 class, taught by Prof. Robin
 * Hillyard
 * <p>
 * It requires Java 8 as it uses function types, in particular,
 * UnaryOperator&lt;T&gt; (a function of T => T),
 * Consumer&lt;T&gt; (essentially a function of T => Void) and Supplier&lt;T&gt;
 * (essentially a function of Void => T).
 * <p>
...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    public double runFromSupplier(Supplier<T> supplier, int m) {
        ...
        System.out.println("DEBUG: Benchmark_Timer run started for " + description);
    ...
    /**
     * Constructor for a Benchmark_Timer with the option of specifying all three
     * functions.
     *
     * @param description the description of the benchmark.
     * @param fPre        a function of T => T.
     *                    Function fPre is run before each invocation of fRun (but
     ...
     *                    sorts an array.
     *                    When you create a lambda defining fRun, you must return
     *                    "null."
